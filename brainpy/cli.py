#!/usr/bin/env python3
"""
Command-line interface for BrainPy
"""
...
from .exceptions import BrainPyError

def main():
    parser = argparse.ArgumentParser(description='BrainPy - Brainfuck to Python converter and executor')
    ...
    try:
        ...
        # Create interpreter
        interpreter = BrainPy(memory_size=args.memory)
