#!/usr/bin/env python3
"""
Command-line interface for bf2py
"""
...
from .exceptions import BF2PyError

def main():
    parser = argparse.ArgumentParser(description='bf2py - Brainfuck to Python converter and executor')
    ...
    try:
        ...
        # Create interpreter
        interpreter = BF2Py(memory_size=args.memory)
